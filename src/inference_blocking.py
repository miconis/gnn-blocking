...
embeddings_model_path = "./log/models/MetaPath2Vec/08-01-2024_14-47-49/MetaPath2Vec-epoch399.ckpt.pth"
...
# create embeddings
author_nids = torch.LongTensor(embeddings_model.local_to_global_nid["author"])
node_embeddings = embeddings_model.node_embed(author_nids).detach()
